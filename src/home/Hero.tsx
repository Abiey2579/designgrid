  ...
  return (
    <div className="my-20">
      ...
      <div className="lg:px-24 md:px-10 px-3 text-center lg:mb-16 md:mb-12 mb-10">
        <h1 className="lg:text-7xl md:text-6xl text-6xl text-dgDarkPurple lg:text-center md:text-center text-left font-black lg:max-w-[700px] md:max-w-full leading-none m-auto mb-4">
        ...
        <ul className={`brands flex items-center `}>
          {ScrollingLogos.map((logo, index) => (
            <img
              ...
              src={logo}
              alt={`Logo ${index + 1}`}
              className="h-16 w-auto mx-6 logos"
            />
          ))}
        </ul>
      </div>
